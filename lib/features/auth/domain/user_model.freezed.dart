...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl(
      ...
      @JsonKey(name: "profilePhotoUrl") this.profilePhotoUrl});
  ...
  @override
  String toString() {
    return 'UserModel(uid: $uid, name: $name, email: $email, profilePhotoUrl: $profilePhotoUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, uid, name, email, profilePhotoUrl);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      @JsonKey(name: "profilePhotoUrl") final String? profilePhotoUrl}) = _$UserModelImpl;
